                                ...
                                <div class="form-body">
                                    <form action="" method="post" enctype="multipart/form-data"> 
                                        <div class="form-group"> 
                                            ...
                                            <select required="" class="form-control" name="s_dept">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-default">Show Class</button> 
                                    </form> 
                                </div>
                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="profile" aria-labelledby="profile-tab"> 
                                    <div class="bs-example widget-shadow" data-example-id="contextual-table"> 
                                        ...
                                        if (isset($_POST["submit"])) {
                                            $dept = htmlentities(addslashes($_POST["s_dept"]));
                                            ...
                                            <table id="example" class="table table-striped"> 
                                                ...
                                                <tbody> 
                                                    <?php
                                                    $result = mysqli_query($conn, "select * from students where dept_id='$dept' and level='$level' order by mat_no");
                                                    $a = 1;
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td><?php echo $smatno; ?></td>
                                                            <td><?php echo $sfullname; ?></td>
                                                            <td><?php echo $dname; ?></td>
                                                            <td><?php echo $slevel; ?></td>
                                                            <td><a href="studentdetails.php?id=<?php echo $smatno; ?>">Biodata</a></td>
                                                        </tr> 
                                                        <?php
                                                        $a++;
                                                    }
