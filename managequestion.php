...
$row1 = mysqli_fetch_array(mysqli_query($conn, "select * from login where email = '$email'"));
$key = $row1["decrypt"];
                            ...
                            <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                                <div class="form-body">
                                    <form action="" method="post" enctype="multipart/form-data"> 
                                        ...
                                        <button type="submit" name="submit" class="btn btn-default">View Question</button> 
                                    </form> 
                                </div>
                            </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="profile" aria-labelledby="profile-tab"> 
                                    <div class="bs-example widget-shadow" data-example-id="contextual-table"> 
                                        ...
                                        if (isset($_POST["submit"])) {
                                            $level = htmlentities(addslashes($_POST["st_level"]));
                                            ?>
                                            <table id="example" class="table table-striped"> 
                                                ...
                                                <tbody> 
                                                    <?php
                                                    $result = mysqli_query($conn, "select * from questionstorage where level='$level'");
                                                    $a = 1;
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="submit" class="btn"><a href="managequestion.php?del=<?php echo $q_id; ?>">DELETE</a></button>
