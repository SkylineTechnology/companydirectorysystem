                    ...
                    <div class="col_3" style="margin-bottom: 10px;">
                        <div class="col-md-6 widget widget1">
                            <div class="r3_counter_box">
                                ...
                                <div class="stats">
                                    ...
                                    ?>
                                    <h5><strong><?php echo "Welcome ".$sfullname; ?></strong></h5>
                                    <span></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 widget">
                            <div class="r3_counter_box">
                                ...
                                <div class="stats">
                                    <?php
                                    $num_users = mysqli_num_rows(mysqli_query($conn, "select * from questionstorage where dept='$sdept_id'"));
                                    ?>
