<div class="col_3" style="margin-bottom: 10px;">
    ...
    <div class="col-md-5 widget widget1">
        <div class="r3_counter_box">
            ...
            <div class="stats">
                <?php
                $num_contact = mysqli_num_rows(mysqli_query($conn, "select * from lecturer"));
                ?>
    ...
    <div class="col-md-5 widget">
        <div class="r3_counter_box">
            ...
            <div class="stats">
                <?php
                $num_users = mysqli_num_rows(mysqli_query($conn, "select * from questionstorage"));
                ?>
                <h5><strong><?php echo $num_users; ?></strong></h5>
                <span>Total Questions Upload</span>
            </div>
        </div>
    </div>
